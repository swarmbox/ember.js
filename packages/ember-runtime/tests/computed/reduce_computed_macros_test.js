...
QUnit.test("updating the sort properties definitions array content triggers recomputeOnce only one time", function () {
  run(function () {
...
QUnit.test("replacing the sort property definitions array itself triggers recomputeOnce only one time", function () {
  var spd;
